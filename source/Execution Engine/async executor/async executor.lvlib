...
<Library LVVersion="13008000">
	...
	<Item Name="process data method.vi" Type="VI" URL="../process data method.vi"/>
	<Item Name="start async worker.vi" Type="VI" URL="../start async worker.vi"/>
	<Item Name="stop async worker.vi" Type="VI" URL="../stop async worker.vi"/>
</Library>
